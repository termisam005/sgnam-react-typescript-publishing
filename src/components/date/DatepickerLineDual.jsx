...
const DatepickerLineDual = ({ wrapClass }) => {
    ...
    const [startDate01, setStartDate01] = useState(new Date());
    const [startDate02, setStartDate02] = useState(new Date());
    ...
    return (
        <div className={wrapClass}>
            ...
            <section className='dflx_ac gap_8'>
                <div onFocus={handleFocus1} onBlur={closeBox1} className={datebox01? 'datebox line w140 datepicker on' : 'datebox line w140 datepicker'}>
                    <DatePicker 
                ...
                <div onFocus={handleFocus2} onBlur={closeBox2} className={datebox02? 'datebox line w140 datepicker on' : 'datebox line w140 datepicker'}>
                    <DatePicker 
                    dateFormat="yyyy/MM/dd" 
...
export default DatepickerLineDual;