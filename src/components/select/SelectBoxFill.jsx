...
const SelectBoxFill = ({ wrapClass, placeholder, disabled }) => {
    ...
    return (
        <section className={wrapClass}>
            ...
            <div onFocus={handleFocus} className={selbox? "selectbox w200 fill h28 gap_8 on" : "selectbox w200 fill h28 gap_8"}>
