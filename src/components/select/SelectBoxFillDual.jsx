...
const SelectBoxFillDual = ({ wrapClass, placeholder1, placeholder2 }) => {
    ...
    return (
        <section className={wrapClass}>
            ...
            <div className="dflx_ac gap_8">
                <div onFocus={handleFocus1} className={selbox1? "selectbox w88 fill h28 gap_8 on" : "selectbox w88 fill h28 gap_8"}>
                ...
                <div>~</div>
                <div onFocus={handleFocus2} className={selbox2? "selectbox w88 fill h28 gap_8 on" : "selectbox w88 fill h28 gap_8"}>
...
export default SelectBoxFillDual;
