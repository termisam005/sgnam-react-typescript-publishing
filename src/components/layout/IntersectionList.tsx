import SearchSettLineComponent from '../search/SearchSettLineComponent';
...
const IntersectionList = ({ IndClass, IndTitle }:Props) => {

    return (
        <article className={IndClass}>
            <h2 className='fs_14_bold'>{IndTitle}</h2>
            <SearchSettLineComponent lineClass={'srch_line m-t-16 m-r-8'} zoneClass={'put_zone'} type={'text'} 
            placeholder={'Search'} />
