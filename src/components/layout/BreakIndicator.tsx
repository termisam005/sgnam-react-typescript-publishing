...
const BreakIndicator = ({ IndClass, IndTitle }:Props) => {
        ...
        <article className={IndClass}>
            ...
            <div className={toggleInd? 'indi_conts del':'indi_conts'}>
                <ul className='record_menu hauto'>
                    <li>
                        <a href='#none' className={menuTab === 1? "on" : ""} onClick={() => tabMenu(1)}>차트</a>
                    </li>
                    <li>
                        <a href='#none' className={menuTab === 2? "on" : ""} onClick={() => tabMenu(2)}>표</a>
                    </li>
                </ul>
