                    ...
                    <div className='board_inner'>
                        ...
                        <div className="header_search col_gap20">
                            <div className="dflx_ac col_gap16">
                                ...
                                <InputComponent type="text" className='wrput trans line w200' />
                                ...
                                <div className='dflx_column flex1'>
                                    <div className="dflx col_gap16">
                                        <div className="edge_block w320">                                    
                                            ...
                                            <div className="chart_bg dflx_ac_jcent h-100">
                                                <ImgComponent className={'w-100'} src='pedestrian_chart01.png' />
                                            </div>
                                        </div>
...
export default StatisticalPedestrian;
