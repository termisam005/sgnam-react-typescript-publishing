        ...
        <div className='wrap_rel'>
          ...
          <section className={"board_left"}>
            <div className='board_line'>
                ...
                <CommuniIndicatorBrief IndClass={'indicator'} IndTitle={'소통정보'} />
                <DelayIndicator IndClass={'indicator m-t-10'} IndTitle={'지체정보'} />
                <ComprehensiveIndicator IndClass={'indicator m-t-10'} IndTitle={'종합 평가'} />
            </div>
          </section>
          ...
          <div className='board_bottom'>
            <IndicatorComponent className={'indicator w-100 m-t-20'}>
                ...
                <div className="tab_line m-t-16">
                    <ButtonComponent type={'button'} className={'btn_line1 btn_xs'} txt={'지표'} />
                    <ButtonComponent type={'button'} className={'btn_line1 btn_xs selected'} txt={'차트'} />
                </div>
