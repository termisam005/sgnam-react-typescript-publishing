                    ...
                    <div className='board_inner'>
                        ...
                        <div className='statistics_body'>
                            <div className="dflx col_gap16">                  
                                <DiagonStatstics contClass={'diagon_statistics'} tltClass={'diagon_tlt'} tlt={'전체 교통량'} resultClass={'diagon_result'} result={'2,227,161'} unitClass={'unit'} unit={'대'}>
                                    <p className='fs_12_medium'>전주 대비 (-0%)</p>
                                </DiagonStatstics>  
                                <DiagonStatstics contClass={'diagon_statistics'} tltClass={'diagon_tlt'} tlt={'서비스 수준 / 평균 제어지체'} resultClass={'diagon_result'} result={'A / 61'} unitClass={'unit'} unit={'대'}>
