          ...
          <section className={"board_left"}>
            <div className='board_line'>
                <div className="tab_dashboard">
                    <Link className={'btn_toggle_floating btn_m flex1'} to="/smart">교통상황 모니터링</Link>
                    <Link className={'btn_toggle_floating btn_m selected flex1'} to="/smartanalysis">교차로 분석</Link>
                </div>
                <IntersectionAnalysis IndClass={'indicator'} IndTitle={'교차로 분석'}></IntersectionAnalysis>
                <IntersectionList IndClass={'indicator overt p-b-0 m-t-8'} IndTitle={'교차로 목록'}></IntersectionList>
            </div>
          </section>
            ...
            <div className='board_bottom'>
                <IndicatorComponent className={'indicator w-100'}>
                    ...
                    <div className="tab_line m-t-16">
                        <ButtonComponent type={'button'} className={'btn_line1 btn_xs selected w76'} txt={'직진'} onClick={''} />
                        <ButtonComponent type={'button'} className={'btn_line1 btn_xs w76'} txt={'접근로별'} onClick={''} />
                    </div>
